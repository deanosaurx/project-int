def call() {
    script {
        sh 'docker build -t ${FRONTEND_IMAGE_NAME} ./app/frontend'
        sh 'docker tag $FRONTEND_IMAGE_NAME ${DOCKER_REGISTRY}/${FRONTEND_IMAGE_NAME}:1.1.${IMAGE_TAG}'
        ...
        sh 'docker push ${DOCKER_REGISTRY}/${FRONTEND_IMAGE_NAME}:1.1.${IMAGE_TAG}'
        }
    }
}